...
export type GenericMorph = Brand | Category | I18NLocale | Product | ReviewWorkflowsWorkflow | ReviewWorkflowsWorkflowStage | UploadFile | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type ProductCollectionQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', documentId: string, name: string, price: number, brand?: { __typename?: 'Brand', name: string, description?: string | null } | null } | null> };
...
export type ProductQuery = { __typename?: 'Query', product?: { __typename?: 'Product', description?: string | null, documentId: string, name: string, price: number, brand?: { __typename?: 'Brand', name: string, products: Array<{ __typename?: 'Product', documentId: string, name: string } | null> } | null } | null };
